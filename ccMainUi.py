...
class Ui_ccMain(object):
    def setupUi(self, ccMain):
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1409, 18))
        ...
        self.resultsDock.setMinimumSize(QtCore.QSize(58, 74))
        ...
        self.logDock.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.scanDock.setMinimumSize(QtCore.QSize(450, 325))
        ...
        self.scanGroup.setGeometry(QtCore.QRect(10, 10, 400, 300))
        ...
        self.scanGroup.setMinimumSize(QtCore.QSize(175, 300))
        ...
        self.radioCELine = QtWidgets.QRadioButton(self.layoutWidget)
        self.radioCELine.setObjectName("radioCELine")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.radioCELine)
        self.cancelButton = QtWidgets.QPushButton(self.layoutWidget)
        self.cancelButton.setEnabled(False)
        self.cancelButton.setObjectName("cancelButton")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.cancelButton)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.runButton)
        self.radioCENeutral = QtWidgets.QRadioButton(self.layoutWidget)
        self.radioCENeutral.setObjectName("radioCENeutral")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.radioCENeutral)
        self.radioCESignal = QtWidgets.QRadioButton(self.layoutWidget)
        self.radioCESignal.setObjectName("radioCESignal")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.radioCESignal)
        ...
        self.radioCELine.clicked.connect(ccMain.ceLineSelectSlot)
        ...
        self.radioCENeutral.clicked.connect(ccMain.ceNeutralSelectSlot)
        self.radioCESignal.clicked.connect(ccMain.ceSignalSelectSlot)
    ...
    def retranslateUi(self, ccMain):
        ...
        self.radioCELine.setText(_translate("ccMain", "CE 150kHz - 30MHz Line"))
        self.cancelButton.setText(_translate("ccMain", "Cancel"))
        self.runButton.setText(_translate("ccMain", "Run"))
        self.radioCENeutral.setText(_translate("ccMain", "CE 150kHz - 30MHz Neutral"))
        self.radioCESignal.setText(_translate("ccMain", "CE 150kHz - 30MHz Signal"))
